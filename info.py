...
PICS = (environ.get('PICS', 'https://files.catbox.moe/cu8far.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7945551029 7822720438').split()] # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002312610528')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002365375059')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002312610528')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://meagan43:fQO5oUgjovox6kWh@rahat1.aebuc.mongodb.net/?retryWrites=true&w=majority&appName=rahat1")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Rm_Supports') # Support Chat Link Without https:// or @
...
# Don't Remove Credit @VJ_Botz
# Subscribe YFalse Channel For Amazing Bot @Tech_VJ
# Ask Doubt on telegram @KingVJ01
